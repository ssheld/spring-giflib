...
// This will be a temporary way for us to store our Gifs. In the future a database will be implemented.
// @Component will allow Spring to pick this up during our initial component scan in AppConfig in order
// for it to be seen by the @Autowire in our GifController.
@Component
